...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cloudstorestorefront/electronics/en",
						"https://electronics.local:9002/cloudstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cloudstorestorefront/electronics/en",
						"https://electronics.local:9002/cloudstorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cloudstorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/cloudstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cloudstorestorefront/electronics/en",
						"https://electronics.local:9002/cloudstorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cloudstorestorefront",
						"https://electronics.local:9002/cloudstorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cloudstorestorefront",
						"https://electronics.local:9002/cloudstorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/cloudstorestorefront/electronics/en",
						"https://electronics.local:9002/cloudstorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
