...
import org.training.test.constants.CloudstoreTestConstants;
 ...
 */
@SystemSetup(extension = CloudstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cloudstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cloudstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/cloudstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/cloudstoretest/import/csquotes.impex");
		}
	}
}
