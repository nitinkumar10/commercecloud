...
/**
 * Global class for all CloudstoreCore constants. You can add global constants for your extension into this class.
 */
public final class CloudstoreCoreConstants extends GeneratedCloudstoreCoreConstants
{
	public static final String EXTENSIONNAME = "cloudstorecore";


	private CloudstoreCoreConstants()
	{
		//empty
	}
